...
#include <ole2.h>
#include <codecvt>
void TestExcel(std::vector<std::vector<int>> Data);
...
void TestExcel(std::vector<std::vector<int>> Data)
{
	...
	std::string FirstCell = "A1";
	FirstCell = CellFromPosition(1, 1);
	std::string LastCell = "E5";
	LastCell = CellFromPosition(DataW, DataH);
	...
	//parm.bstrVal = ::SysAllocString(L"A1:E5");
